...
var exports = module.exports = (function () {
    ...
    return {
        ...
        addAssetsToStream: function (file, paths, files) {
            ...
            //   options.concat - for concat files otions like {newLine: ';'}
            var concat_options = options.concat || {};
            //concat_options.path = name;
            src
                .pipe(gulpif(!options.noconcat, concat(name,concat_options)))
